...
Now, we can utilize the elbow method in order to select the number of clusters.
...
We see that the most regularized fit has been
...
print("Most regularized fit attained for lambda:")
print(lasso.poly.model$lambda.1se)
